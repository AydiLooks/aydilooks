   ...
   const{Removefromcart,setDecrease,setIncrease}=useCartContext();
    return (
            ...
            <div className='grid grid-cols-5 mt-16'>
                ...
                <div className='image'>
                    <img src={image} alt={id} className='h-24' />
                </div>
                <div className='grid grid-rows-2'><p className='text-xl'>{name}</p>
                <div className=''><p>Color:</p>
                    <div style={{ backgroundColor: `${color}` }} className='w-4 h-4 rounded-full inline-block mr-2'></div>
                </div>
                </div>
                </div>
